...
# --- CONFIG FOR GETLEVERAGED #3 ---
SYMBOL = "BTCUSD"
VOLUME = 0.01
MAGIC = 7773  # Unique Magic
TERMINAL_PATH = r"C:\Program Files\GetLeveraged MT5 Terminal\terminal64.exe"

def log(msg):
    print(f"GL_BOT_3 >> {msg}")
    try:
        with open("passive_gl_3.log", "a") as f:
            f.write(f"{msg}\n")
    except:
        pass
...
def main():
    ...
    if not acc:
        log("Please log into GetLeveraged Account 3 manually.")
        return
